...
Current compiled-in ids: `cline`, `codex`, `cometixcode`, `commandcode`, `crow`, `crush`, `deepseek-harness`, `fast-agent`, `gajae`, `goose`, `grok`, `hermes`, `jcode`, `kimi`, `mimocode`, `omp`, `openclaw`, `opencode`, `pi`, `prime-agent`, `zcode`.
