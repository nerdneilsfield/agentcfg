...
Current compiled-in ids: `aider`, `cline`, `codex`, `cometixcode`, `commandcode`, `continue`, `crow`, `crush`, `deepseek-harness`, `fast-agent`, `gajae`, `goose`, `grok`, `hermes`, `jcode`, `kilo`, `kimi`, `mimocode`, `omp`, `openclaw`, `opencode`, `pi`, `prime-agent`, `qwen-code`, `zcode`.
